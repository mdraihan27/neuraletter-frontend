...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <ForgetPasswordForm className={"w-full max-w-[420px] px-5 mt-28 sm:mt-40 lg:mt-48 mb-16 sm:mb-24 lg:mb-32 lg:scale-110 "} setIsLoading={setIsLoading}></ForgetPasswordForm>
      <FooterColumns01 />
    </div>
  );
}
