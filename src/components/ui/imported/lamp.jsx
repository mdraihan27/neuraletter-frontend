...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[450px] md:h-[600px] lg:h-[900px] flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md z-0",
        className
      )}>
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-focused via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-focused text-white [--conic-position:from_290deg_at_center_top]">
          <div
        ...
        <div
          className="absolute inset-auto z-50 h-12 w-[28rem] -translate-y-1/2 rounded-full bg-focused opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-12 w-[28rem] -translate-y-[6rem] rounded-full bg-focused blur-3xl"></motion.div>
        <motion.div
          initial={{ width: "25rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-focused "></motion.div>
